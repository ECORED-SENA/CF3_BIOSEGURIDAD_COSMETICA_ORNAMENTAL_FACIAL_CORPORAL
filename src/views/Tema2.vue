...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center
      .col-lg-6.align-self-center(data-aos="fade-right") 
        .contenedor.contenedor--texto-right
          ...
          p Realizada una aproximación a la clasificación de los productos cosméticos, se hace necesario hablar sobre su almacenamiento y conservación, y deben seguir lineamientos que garanticen la vida útil de los mismos, por ello se sugiere cumplir con las siguientes recomendaciones.
      .col-lg-5.align-self-center(data-aos="fade-left") 
        figure.mb-5
          img.img500(src="@/assets/curso/tema2/img08.svg")
    
      .row.justify-content-center.mt-3.me-0
        .col-lg-10
          .titulo-sexto.color-acento-contenido
              <b>Tabla 1</b> 
              span.fst-italic Normas de conservación y almacenamiento
    ...
    .row.justify-content-center.mb-4(data-aos="zoom-in-up")
      .col-lg-10.mb-5
          table
            tr.bg07
              td
                .h6.text-white.text-center Normas de conservación 
              td
                .h6.text-white.text-center Normas de almacenamiento 
            tr.bg08
              td.p-4 Leer cuidadosamente las instrucciones de uso dadas por el fabricante las cuales se encuentran en el rótulo y tener mucha atención con las advertencias y precauciones. 
              td.p-4 Almacenar los productos cosméticos en un lugar limpio.<br>
            tr.bg03
              td.p-4 Manipular los cosméticos con los elementos de seguridad tales como aplicadores para evitar que se contaminen.
              td.p-4 Almacenar los productos cosméticos en un lugar seco.<br>
            tr.bg08
              td.p-4 No utilizar bajo ninguna circunstancia aquellos productos cosméticos que hayan cambiado su aspecto como el color, la apariencia y el olor; o cuando ya se encuentren vencidos. 
              td.p-4 No exponerlos a cambios bruscos de temperatura.<br>
            tr.bg03
              td.p-4 Al detectar algún tipo de reacción adversa cuando se utiliza un producto cosmético, se debe suspender el uso. Si la molestia persiste hay que consultar con personal médico. 
              td.p-4 Comprar los productos cosméticos, en lugares seguros que brinden confianza respecto a su origen y procesos de elaboración.<br>
            tr.bg08
              td.p-4
              td.p-4 Conservar los productos cosméticos en el envase original. Posterior al uso, se debe verificar que queden bien cerrados.<br>
      ...
      .col-lg-5.bg09.mb-5(data-aos="fade-right") 
        SlyderA(tipo="b")
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 1
            .col-12.mb-4.p-5
              p.text-white La ubicación debe darse de manera tal que se evite la contaminación de los productos cosméticos.
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 2
            .col-12.mb-4.p-5
              p.text-white Asignar un espacio para los extintores acorde con las características de cada grupo de productos a utilizar. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 3
            .col-12.mb-4.p-5
              p.text-white El área de almacenamiento debe facilitar el adecuado desplazamiento de los colaboradores internos y de los productos cosméticos a utilizar. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 4
            .col-12.mb-4.p-5
              p.text-white Propiciar condiciones de tipo ambiental en el marco de la temperatura, la luz, el aire y la humedad de los productos cosméticos a utilizar. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 5
            .col-12.mb-4.p-5
              p.text-white Las paredes, pisos y techos deben permitir la limpieza y desinfección de las áreas; así mismo, deben evitar el ingreso de insectos, aves, roedores, polvo y otros tipos de contaminantes. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 6
            .col-12.p-4
              p.ms-4.me-3.text-white La iluminación debe ser agradable y que facilite la búsqueda de los productos a utilizar. Se recomienda evitar el uso de ventanas grandes o claraboyas que permitan el acceso directo de la luz del sol sobre los productos o estantes, puesto que la radiación solar puede elevar la temperatura ambiental y generar cambios en los elementos almacenados.
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
          ...
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 1
            .col-12.mb-4.p-5
              p.text-white Establecer las especificaciones requeridas. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 2
            .col-12.mb-4.p-5
              p.text-white Organizar los lineamientos de calidad para la aprobación de la compra. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 3
            .col-12.mb-4.p-5
              p.text-white Establecer las características de la relación proveedor-consumidor por medio de asistencias técnicas y ejercicios de auditoría. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 4
            .col-12.mb-4.p-5
              p.text-white Tener presente las verificaciones realizadas por el abastecedor. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 5
            .col-12.mb-4.p-5
              p.text-white Definir los términos contractuales en donde se garanticen todos los aspectos de calidad del producto. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 6
            .col-12.mb-4.p-5
              p.text-white Tener presente otros elementos como las solicitudes de precio, tiempos de entrega, o servicio postventa de ser necesario. 
          .row.justify-content-center
            .col-1.mt-5.me-2
              .BGIMG03.p-2.text-center
                h1.text-white.mb-2 7
            .col-12.mb-4.p-5
              p.text-white En los aspectos que tienen que ver con la calidad del producto, es importante tener presente que ellos sean fabricados teniendo en cuenta las normas específicas de buenas prácticas de manufactura para garantizar su calidad.

    p Sumado a lo anterior, en los establecimientos de cosmética ornamental, facial y corporal se debe tener una ficha técnica de los productos. Es un documento que contiene la información detallada sobre las características y propiedades que identifican sus elementos utilizados en la producción, características de tipo físico y técnico, las recomendaciones, los modos de utilización y otros datos relevantes. 
    br
    ...
    .cajon.color-primario.p-4.mb-4.justify-content-center(data-aos="zoom-in-up")
    ...
    .row.justify-content-center
      .col-lg-4(data-aos="fade-left") 
        figure
          img.img386.pe-4.mb-4.mt-4(src="@/assets/curso/tema2/img12.svg") 
      .col-lg-6(data-aos="fade-right") 
        .contenedor.contenedor--texto-right2
          p.mt-5.pt-5.me-5 El fabricante o importador debe contar y entregar los servicios para verificar la calibración, el mantenimiento y aprovisionamiento de todos los insumos y repuestos que se puedan necesitar; así como garantizar la capacitación necesaria tanto en el marco de lo operativo como en el mantenimiento básico del equipamiento. Los centros de estética deben listar todas las acciones para el mantenimiento realizadas por ellos o por prestadores de este servicio de mantenimiento que hayan sido contratados. Además, estos informes pueden ser pedidos por las autoridades sanitarias competentes cuando sea necesario. 
    
    p.mt-4 Los productos de tipo cosméticos que son usados en los servicios de cosmética ornamental, facial y corporal, están regulados por la Decisión 516 de 2002 de la Comunidad Andina de Naciones (CAN) la cual establece la armonización de legislaciones en el marco de la materia de productos cosméticos.
